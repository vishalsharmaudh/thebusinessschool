...
export declare type Variants<V, AnimateType = ImageStyle & TextStyle & ViewStyle, AnimateWithTransitions = StyleValueWithReplacedTransforms<AnimateType>, Animate = StyleValueWithSequenceArrays<AnimateWithTransitions>> = {
 ...
 */
export declare type DynamicStyleProp<AnimateType = ImageStyle & ViewStyle & TextStyle, AnimateWithTransitions = StyleValueWithReplacedTransforms<AnimateType>> = NonNullable<StyleValueWithSequenceArrays<AnimateWithTransitions>>;
